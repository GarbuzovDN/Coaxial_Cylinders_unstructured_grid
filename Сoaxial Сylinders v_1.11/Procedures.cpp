...
void Flow_Evolution(string param) {
    ...
    if (param == "line")
    {
        ...
        if (Iter_Glob % 50 == 0 || Iter_Glob == 1)
        {
            ...
            for (int i = 0; i < count_marker; i++)
            {
                ...
                /* Координаты для вращения лопастей,а не стенки */
    ...
    if (param == "array")
    {
        ...
        /* Запись в файл интегральной характеристики */
